...
def build_imagenet_generative_model(args):
	...
	H = Activation('relu')(H)
	H = UpSampling2D(size=(2, 2))(H)
	H = Conv2D(nch*3, (2, 2), padding='same', kernel_initializer='glorot_uniform')(H)
	H = Activation('relu')(H)
	H = Conv2D(nch*3, (3, 3), padding='same', kernel_initializer='glorot_uniform')(H)
	H = Activation('relu')(H)	
	H = Conv2D(nch*2, (5, 5), padding='same', kernel_initializer='glorot_uniform')(H)
	#H = batch_normalize_or_not(args, H, channel_axis)
	H = Activation('relu')(H)	
...
def build_imagenet_discriminative(args):
	...
	H = Conv2D(216, (5, 5), padding='valid', kernel_initializer='glorot_uniform')(d_input)
	H = MaxPooling2D((3, 3))(H)
	H = Dropout(args.dropout)(H)
	H = Activation('relu')(H)
	H = Conv2D(160,  (3, 3), padding='valid', kernel_initializer='glorot_uniform')(d_input)
	H = MaxPooling2D((2, 2))(H)
	H = Dropout(args.dropout)(H)
	H = Activation('relu')(H)
	H = Conv2D(128,  (3, 3), padding='valid', kernel_initializer='glorot_uniform')(H)
	H = MaxPooling2D((2, 2))(H)
	H = Dropout(args.dropout)(H)
	H = Activation('relu')(H)
	H = Conv2D(96,  (3, 3),  padding='valid', kernel_initializer='glorot_uniform')(H)
	H = MaxPooling2D((2, 2))(H)
	H = Dropout(args.dropout)(H)
	H = Activation('relu')(H)
