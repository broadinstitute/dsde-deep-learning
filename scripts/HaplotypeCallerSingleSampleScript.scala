...
class HaplotypeCallerSingleSampleScript extends QScript {
  ...
  // Script arguments
  @Argument(shortName = "sc", required = false, doc = "Scatter count") var jobs: Int = 100
  ...
  @Argument(shortName = "mem", required = false, doc = "memory for the jvm") var memoryLimit = 60
  @Argument(shortName = "assess", required = false, doc = "run NA12878 assessment") var assess: Boolean = false
  @Argument(shortName = "bamout", required = false, doc = "Bamout file") var bamout: File = _
  @Argument(shortName = "dontTrimActive", required = false, doc = "Trim active regions") var dontTrimActive: Boolean = false
  @Argument(shortName = "minConfidenceEmit", required = false, doc = "Standard min confidence phred") var minConfidenceEmit = 10.0
  @Argument(shortName = "minDangle", required = false, doc = "Minimum length of a dangling branch to attempt recovery") var minDangle: Int = 4
  ...
  def script() {
    ...
    hc.bamout = bamout
    hc.dontTrimActiveRegions = dontTrimActive
    hc.standard_min_confidence_threshold_for_calling = minConfidenceEmit
    hc.minDanglingBranchLength = minDangle
    // Walker optional arguments
    ...
    if (assess) {
      ...
      kb.out = swapExt(hc_output, ".vcf", ".assessment")
